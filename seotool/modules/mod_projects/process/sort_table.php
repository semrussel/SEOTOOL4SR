...
//	var_dump($_POST);
	...
	$mysql->query('SELECT DATE_FORMAT(MONTHYEAR, "%b %Y") AS MONTH_YEAR, REPORTTITLE, DATECREATED, REPORTID, FILE FROM REPORT WHERE WEBSITEID = '.$_POST['id'].' ORDER BY '.$_POST['accdg'].' '.$_POST['asc'].';');
?>
		...
		<thead>
			<tr>
				...
				<th class="sort_by">Sort by:
					<button class="btn" title="Month" id="sort_by_month" onclick="sort('MONTHYEAR');"><i class="icon-calendar"></i></button>
